<?php include './database/db_createDb.php'; ?>
<?php
// $email = "";
...
//   $sql = "INSERT INTO contact VALUES ('','$email','$name','$comments')";
...
<head>
  ...
  .jumbotron {
      background-image : url('./img/photo-1505238680356-667803448bb6.jpg');
      color: #fff;
      padding: 100px 25px;
...
<nav class="navbar navbar-inverse navbar-fixed-top index_nav">
  <div class="container">
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    <div class="col-sm-4">
      ...
      <h4>POWER</h4>
      <p>We have power to deliver</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-heart logo-small"></span>
      <h4>LOVE</h4>
      <p>We love our customer deeply</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-lock logo-small"></span>
      <h4>JOB DONE</h4>
      <p>Job done at fast rate</p>
    </div>
  </div>
  <br><br>
  <div class="row slideanim">
    <div class="col-sm-4">
      ...
      <h4>GREEN</h4>
      <p>We are ever green</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-certificate logo-small"></span>
      <h4>CERTIFIED</h4>
      <p>We have global cartification</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-wrench logo-small"></span>
      <h4 style="color:#303030;">HARD WORK</h4>
      <p>Hard work is our watch word</p>
    </div>
  </div>
</div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCzHVv5pu7rNja16CMPKMjbL1yfk-6vtgg&callback=myMap"></script>
<!--
